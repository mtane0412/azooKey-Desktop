...
extension Config {
    public struct ZenzaiProfile: StringConfigItem {
        ...
        public static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.ZenzaiProfile"
    }
}
...
extension Config {
    ...
    public struct OpenAiModelName: StringConfigItem {
        ...
        public static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.OpenAiModelName"
    }
    ...
    public struct OpenAiApiEndpoint: StringConfigItem {
        ...
        public static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.OpenAiApiEndpoint"
    ...
    public struct PromptHistory: StringConfigItem {
        public static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.PromptHistory"
    }
}
