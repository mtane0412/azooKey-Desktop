...
extension Config.Deprecated {
    ...
    struct TypeCommaAndPeriod: BoolConfigItem {
        ...
        static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.typeCommaAndPeriod"
    }
    ...
    struct ZenzaiIntegration: BoolConfigItem {
        ...
        static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.enableZenzai"
    }
    ...
    struct EnableOpenAiApiKey: BoolConfigItem {
        static let `default` = false
        static let key: String = "dev.mtane0412.inputmethod.azooKeyMac.preference.enableOpenAiApiKey"
    }
}
